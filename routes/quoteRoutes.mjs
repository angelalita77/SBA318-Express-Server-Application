...
// create express instant and save in router (instead of app)
...
router
    ...
    //READ 
    // @route: GET /quotes
    // @desc: Get ALL quotes, character and show data
    // @access: Public
    .get((req, res) => {
        res.json(quotes);
    });
...
// ----------------------- Disrecard ------------------------
// I wanted to be able to GET the quote and the characters and show by their IDs
// but result wasn't correct.
//     // READ 
//     // @route: GET /quotes
//     // @desc: Get ALL quotes, character and show data
//     // @access: Public
